...
void x264_sps_init(x264_sps_t *sps, int i_id, x264_param_t *param)
{
    ...
    sps->i_chroma_format_idc = csp >= X264_CSP_I444 ? CHROMA_444 : csp >= X264_CSP_I422 ? CHROMA_422 : csp >= X264_CSP_I420 ? CHROMA_420 : CHROMA_400;
    ...
    sps->vui.i_max_dec_frame_buffering = sps->i_num_ref_frames = X264_MIN(
        X264_REF_MAX, X264_MAX4(param->i_frame_reference, 1 + sps->vui.i_num_reorder_frames, param->i_bframe_pyramid ? 4 : 1, param->i_dpb_size));
    ...
    sps->vui.b_chroma_loc_info_present = param->vui.i_chroma_loc > 0 && param->vui.i_chroma_loc <= 5 && sps->i_chroma_format_idc == CHROMA_420;
...
int x264_sei_version_write(x264_t *h, bs_t *s)
{
    ...
    static const uint8_t uuid[16] = {0xdc, 0x45, 0xe9, 0xbd, 0xe6, 0xd9, 0x48, 0xb7, 0x96, 0x2c, 0xd8, 0x20, 0xd9, 0x23, 0xee, 0xef};
...
int x264_validate_levels(x264_t *h, int verbose)
{
    ...
    if (l->frame_size < mbs || l->frame_size * 8 < h->sps->i_mb_width * h->sps->i_mb_width ||
