...
#define DECL_X1_SSD_SVE() DECL_PIXELS_SSD_SVE(int, (pixel *, intptr_t, pixel *, intptr_t))
...
void x264_pixel_ssim_4x4x2_core_neon(const pixel *, intptr_t, const pixel *, intptr_t, int sums[2][4]);
