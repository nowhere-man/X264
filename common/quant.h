...
#define TRELLIS_PARAMS                                                                                                           \
    const int *unquant_mf, const uint8_t *zigzag, int lambda2, int last_nnz, dctcoef *coefs, dctcoef *quant_coefs, dctcoef *dct, \
        uint8_t *cabac_state_sig, uint8_t *cabac_state_last, uint64_t level_state0, uint16_t level_state1
