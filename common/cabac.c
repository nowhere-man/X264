...
void x264_cabac_init(x264_t *h)
{
    ...
    for (int i = 0; i < 4; i++) {
        const int8_t (*cabac_context_init)[1024][2] = i == 0 ? &x264_cabac_context_init_I : &x264_cabac_context_init_PB[i - 1];
...
static const int bypass_lut[16] = {-1,      0x2,     0x14,     0x68,     0x1d0,     0x7a0,     0x1f40,     0x7e80,
