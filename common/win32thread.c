...
int x264_pthread_create(x264_pthread_t *thread, const x264_pthread_attr_t *attr, void *(*start_routine)(void *), void *arg)
{
...
int x264_pthread_cond_destroy(x264_pthread_cond_t *cond) { return 0; }
...
int x264_pthread_cond_wait(x264_pthread_cond_t *cond, x264_pthread_mutex_t *mutex) { return !SleepConditionVariableCS(cond, mutex, INFINITE); }

int x264_win32_threading_init(void) { return x264_pthread_mutex_init(&static_mutex, NULL); }
