...
#define DECL_X1(name, suffix) DECL_PIXELS(int, name, suffix, (uint8_t *, int, uint8_t *, int))
...
void x264_pixel_ssim_4x4x2_core_neon(const uint8_t *, intptr_t, const uint8_t *, intptr_t, int sums[2][4]);
