...
typedef struct x264_frame {
    ...
    int i_frame;         /* Presentation frame number:display order */
    int i_coded;         /* Coded frame number */
    int64_t i_field_cnt; /* Presentation field count */
    int i_frame_num;     /* 7.4.3 frame_num:decode order */
    int b_kept_as_ref;
    int i_pic_struct;
    int b_keyframe;
    uint8_t b_fdec;
...
typedef struct {
    ...
    void (*deblock_strength)(uint8_t nnz[X264_SCAN8_SIZE], int8_t ref[2][X264_SCAN8_LUMA_SIZE], int16_t mv[2][X264_SCAN8_LUMA_SIZE][2],
