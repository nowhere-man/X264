...
void x264_sub4x4_dct_altivec(int16_t dct[16], uint8_t *pix1, uint8_t *pix2)
{
    ...
    VEC_TRANSPOSE_4(tmp0v, tmp1v, tmp2v, tmp3v, dct0v, dct1v, dct2v, dct3v);
...
void x264_sub8x8_dct_altivec(int16_t dct[4][16], uint8_t *pix1, uint8_t *pix2)
{
    ...
    VEC_TRANSPOSE_8(tmp0v, tmp1v, tmp2v, tmp3v, tmp4v, tmp5v, tmp6v, tmp7v, dct0v, dct1v, dct2v, dct3v, dct4v, dct5v, dct6v, dct7v);
...
void x264_sub8x8_dct_dc_altivec(int16_t dct[4], uint8_t *pix1, uint8_t *pix2)
{
    ...
    vec_u8_t mask = {0x00, 0x01, 0x00, 0x01, 0x04, 0x05, 0x04, 0x05, 0x02, 0x03, 0x02, 0x03, 0x06, 0x07, 0x06, 0x07};
...
void x264_sub8x8_dct8_altivec(int16_t dct[64], uint8_t *pix1, uint8_t *pix2)
{
    ...
    DCT8_1D_ALTIVEC(dct0v, dct1v, dct2v, dct3v, dct4v, dct5v, dct6v, dct7v);

    vec_s16_t dct_tr0v, dct_tr1v, dct_tr2v, dct_tr3v, dct_tr4v, dct_tr5v, dct_tr6v, dct_tr7v;

    VEC_TRANSPOSE_8(dct0v, dct1v, dct2v, dct3v, dct4v, dct5v, dct6v, dct7v, dct_tr0v, dct_tr1v, dct_tr2v, dct_tr3v, dct_tr4v, dct_tr5v, dct_tr6v,
                    dct_tr7v);

    DCT8_1D_ALTIVEC(dct_tr0v, dct_tr1v, dct_tr2v, dct_tr3v, dct_tr4v, dct_tr5v, dct_tr6v, dct_tr7v);
...
void x264_add8x8_idct8_altivec(uint8_t *dst, int16_t dct[64])
{
    ...
    VEC_TRANSPOSE_8(d0, d1, d2, d3, d4, d5, d6, d7, tr0, tr1, tr2, tr3, tr4, tr5, tr6, tr7);
