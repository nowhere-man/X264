...
#define MC_WEIGHT_LSX(func)                                                                                         \
    static void (*mc##func##_wtab_lsx[6])(uint8_t *, intptr_t, uint8_t *, intptr_t, const x264_weight_t *, int) = { \
        x264_mc_weight_w4##func##_lsx,  x264_mc_weight_w4##func##_lsx,  x264_mc_weight_w8##func##_lsx,              \
        x264_mc_weight_w16##func##_lsx, x264_mc_weight_w16##func##_lsx, x264_mc_weight_w20##func##_lsx,             \
    };

#define MC_WEIGHT(func)                                                                                              \
    static void (*mc##func##_wtab_lasx[6])(uint8_t *, intptr_t, uint8_t *, intptr_t, const x264_weight_t *, int) = { \
        x264_mc_weight_w4##func##_lasx,  x264_mc_weight_w4##func##_lasx,  x264_mc_weight_w8##func##_lasx,            \
        x264_mc_weight_w16##func##_lasx, x264_mc_weight_w16##func##_lasx, x264_mc_weight_w20##func##_lasx,           \
    };
...
static weight_fn_t mc_weight_wtab_lsx[6] = {
    x264_mc_weight_w4_lsx, x264_mc_weight_w4_lsx, x264_mc_weight_w8_lsx, x264_mc_weight_w16_lsx, x264_mc_weight_w16_lsx, x264_mc_weight_w20_lsx,
};

static void (*const pixel_avg_wtab_lsx[6])(uint8_t *, intptr_t, uint8_t *, intptr_t, uint8_t *, int) = {
    NULL, x264_pixel_avg2_w4_lsx, x264_pixel_avg2_w8_lsx, x264_pixel_avg2_w16_lsx, x264_pixel_avg2_w16_lsx, x264_pixel_avg2_w20_lsx,
};

static void (*const mc_copy_wtab_lsx[5])(uint8_t *, intptr_t, uint8_t *, intptr_t, int) = {
    NULL, x264_mc_copy_w4_lsx, x264_mc_copy_w8_lsx, NULL, x264_mc_copy_w16_lsx,
};
...
static weight_fn_t mc_weight_wtab_lasx[6] = {
    x264_mc_weight_w4_lasx, x264_mc_weight_w4_lasx, x264_mc_weight_w8_lasx, x264_mc_weight_w16_lasx, x264_mc_weight_w16_lasx, x264_mc_weight_w20_lasx,
};

static void (*const pixel_avg_wtab_lasx[6])(uint8_t *, intptr_t, uint8_t *, intptr_t, uint8_t *, int) = {
    NULL, x264_pixel_avg2_w4_lasx, x264_pixel_avg2_w8_lasx, x264_pixel_avg2_w16_lasx, x264_pixel_avg2_w16_lasx, x264_pixel_avg2_w20_lasx,
};

static void (*const mc_copy_wtab_lasx[5])(uint8_t *, intptr_t, uint8_t *, intptr_t, int) = {
    NULL, x264_mc_copy_w4_lasx, x264_mc_copy_w8_lasx, NULL, x264_mc_copy_w16_lasx,
};

static uint8_t *get_ref_lsx(uint8_t *p_dst, intptr_t *p_dst_stride, uint8_t *p_src[4], intptr_t i_src_stride, int32_t m_vx, int32_t m_vy,
                            int32_t i_width, int32_t i_height, const x264_weight_t *pWeight)
{
    ...
    p_src1 = p_src[x264_hpel_ref0[i_qpel_idx]] + i_offset + (3 == r_vy) * i_src_stride;

    if (i_qpel_idx & 5) {
        uint8_t *p_src2 = p_src[x264_hpel_ref1[i_qpel_idx]] + i_offset + (3 == r_vx);
        pixel_avg_wtab_lsx[width](p_dst, *p_dst_stride, p_src1, i_src_stride, p_src2, i_height);
...
static void mc_luma_lsx(uint8_t *p_dst, intptr_t i_dst_stride, uint8_t *p_src[4], intptr_t i_src_stride, int32_t m_vx, int32_t m_vy, int32_t i_width,
                        int32_t i_height, const x264_weight_t *pWeight)
{
    ...
    if (i_qpel_idx & 5) {
        ...
        pixel_avg_wtab_lsx[i_width >> 2](p_dst, i_dst_stride, p_src1, i_src_stride, p_src2, i_height);
...
void x264_mc_chroma_lsx(uint8_t *p_dst_u, uint8_t *p_dst_v, intptr_t i_dst_stride, uint8_t *p_src, intptr_t i_src_stride, int32_t m_vx, int32_t m_vy,
                        int32_t i_width, int32_t i_height);

static uint8_t *get_ref_lasx(uint8_t *p_dst, intptr_t *p_dst_stride, uint8_t *p_src[4], intptr_t i_src_stride, int32_t m_vx, int32_t m_vy,
                             int32_t i_width, int32_t i_height, const x264_weight_t *pWeight)
{
    int32_t i_qpel_idx;
    int32_t i_offset;
    ...
    if (i_qpel_idx & 5) {
        uint8_t *p_src2 = p_src[x264_hpel_ref1[i_qpel_idx]] + i_offset + (3 == r_vx);
        pixel_avg_wtab_lasx[width](p_dst, *p_dst_stride, p_src1, i_src_stride, p_src2, i_height);
...
static void mc_luma_lasx(uint8_t *p_dst, intptr_t i_dst_stride, uint8_t *p_src[4], intptr_t i_src_stride, int32_t m_vx, int32_t m_vy, int32_t i_width,
                         int32_t i_height, const x264_weight_t *pWeight)
{
    int32_t i_qpel_idx;
    int32_t i_offset;
    ...
    if (i_qpel_idx & 5) {
        ...
        pixel_avg_wtab_lasx[i_width >> 2](p_dst, i_dst_stride, p_src1, i_src_stride, p_src2, i_height);
...
void x264_mc_chroma_lasx(uint8_t *p_dst_u, uint8_t *p_dst_v, intptr_t i_dst_stride, uint8_t *p_src, intptr_t i_src_stride, int32_t m_vx, int32_t m_vy,
                         int32_t i_width, int32_t i_height);
