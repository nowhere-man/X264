...
#if !HIGH_BIT_DEPTH
#define AVC_LPF_P0P1P2_OR_Q0Q1Q2(p3_or_q3_org_in, p0_or_q0_org_in, q3_or_p3_org_in, p1_or_q1_org_in, p2_or_q2_org_in, q1_or_p1_org_in, p0_or_q0_out, \
...
#define AVC_LPF_P1_OR_Q1(p0_or_q0_org_in, q0_or_p0_org_in, p1_or_q1_org_in, p2_or_q2_org_in, negate_tc_in, tc_in, p1_or_q1_out) \
    {                                                                                                                           \
        v8i16 clip3, temp;                                                                                                      \
                                                                                                                                \
        clip3 = (v8i16)__msa_aver_u_h((v8u16)p0_or_q0_org_in, (v8u16)q0_or_p0_org_in);                                          \
...
#define AVC_LPF_P0Q0(q0_or_p0_org_in, p0_or_q0_org_in, p1_or_q1_org_in, q1_or_p1_org_in, negate_threshold_in, threshold_in, p0_or_q0_out, \
                     q0_or_p0_out)                                                                                                        \
    {                                                                                                                                     \
...
static void avc_loopfilter_luma_intra_edge_hor_msa(uint8_t *p_data, uint8_t u_alpha_in, uint8_t u_beta_in, uint32_t u_img_width)
{
    ...
    LD_UB4(p_data - (u_img_width << 1), u_img_width, p1_org, p0_org, q0_org, q1_org);
    ...
    if (!__msa_test_bz_v(is_less_than)) {
        ...
        negate_is_less_than_beta = negate_is_less_than_beta & is_less_than;
        {
            ...
            is_less_than_beta_r = (v8u16)__msa_sldi_b((v16i8)is_less_than_beta, zero, 8);
            if (!__msa_test_bz_v((v16u8)is_less_than_beta_r)) {
                v8i16 p3_org_r;

                ILVR_B2_SH(zero, p3_org, zero, p2_org, p3_org_r, p2_r);
                AVC_LPF_P0P1P2_OR_Q0Q1Q2(p3_org_r, p0_org_r, q0_org_r, p1_org_r, p2_r, q1_org_r, p0_r, p1_r, p2_r);
            }

            q1_org_l = (v8i16)__msa_ilvl_b(zero, (v16i8)q1_org);

            is_less_than_beta_l = (v8u16)__msa_sldi_b(zero, (v16i8)is_less_than_beta, 8);

            if (!__msa_test_bz_v((v16u8)is_less_than_beta_l)) {
                v8i16 p3_org_l;

                ILVL_B2_SH(zero, p3_org, zero, p2_org, p3_org_l, p2_l);
                AVC_LPF_P0P1P2_OR_Q0Q1Q2(p3_org_l, p0_org_l, q0_org_l, p1_org_l, p2_l, q1_org_l, p0_l, p1_l, p2_l);
            }
        }
        /* combine and store */
        ...
        }
        {
            ...
            negate_is_less_than_beta_r = (v8u16)__msa_sldi_b((v16i8)negate_is_less_than_beta, zero, 8);
            if (!__msa_test_bz_v((v16u8)negate_is_less_than_beta_r)) {
                AVC_LPF_P0_OR_Q0(p0_org_r, q1_org_r, p1_org_r, p0_r);
            }

            negate_is_less_than_beta_l = (v8u16)__msa_sldi_b(zero, (v16i8)negate_is_less_than_beta, 8);
...

        {
            ...
            if (!__msa_test_bz_v((v16u8)is_less_than_beta_r)) {
                ...
                AVC_LPF_P0P1P2_OR_Q0Q1Q2(q3_org_r, q0_org_r, p0_org_r, q1_org_r, q2_r, p1_org_r, q0_r, q1_r, q2_r);
            }
            is_less_than_beta_l = (v8u16)__msa_sldi_b(zero, (v16i8)is_less_than_beta, 8);
            if (!__msa_test_bz_v((v16u8)is_less_than_beta_l)) {
                v8i16 q3_org_l;
                ...
                AVC_LPF_P0P1P2_OR_Q0Q1Q2(q3_org_l, q0_org_l, p0_org_l, q1_org_l, q2_l, p1_org_l, q0_l, q1_l, q2_l);
            }
        }
...
static void avc_loopfilter_luma_intra_edge_ver_msa(uint8_t *p_data, uint8_t u_alpha_in, uint8_t u_beta_in, uint32_t u_img_width)
{
    uint8_t *p_src;
...

    {
        ...
        LD_UB8(p_src, u_img_width, row0, row1, row2, row3, row4, row5, row6, row7);
        LD_UB8(p_src + (8 * u_img_width), u_img_width, row8, row9, row10, row11, row12, row13, row14, row15);

        TRANSPOSE16x8_UB_UB(row0, row1, row2, row3, row4, row5, row6, row7, row8, row9, row10, row11, row12, row13, row14, row15, p3_org, p2_org,
                            p1_org, p0_org, q0_org, q1_org, q2_org, q3_org);
    }
    ...
    if (!__msa_test_bz_v(is_less_than)) {
...

        {
            ...
            is_less_than_beta_r = (v16u8)__msa_sldi_b((v16i8)is_less_than_beta, zero, 8);
...

        {
            ...
            is_less_than_beta_l = (v16u8)__msa_sldi_b(zero, (v16i8)is_less_than_beta, 8);
        ...
        }
        {
            ...
            negate_is_less_than_beta_r = (v16u8)__msa_sldi_b((v16i8)negate_is_less_than_beta, zero, 8);
        ...
        }
        {
            ...
            negate_is_less_than_beta_l = (v16u8)__msa_sldi_b(zero, (v16i8)negate_is_less_than_beta, 8);
...
static void avc_lpf_cbcr_interleaved_intra_edge_hor_msa(uint8_t *p_chroma, uint8_t u_alpha_in, uint8_t u_beta_in, uint32_t u_img_width)
{
    ...
    LD_UB4(p_chroma - (u_img_width << 1), u_img_width, p1_org, p0_org, q0_org, q1_org);
    ...
    if (!__msa_test_bz_v(is_less_than)) {
        ...
        if (!__msa_test_bz_v(is_less_than_r)) {
            ...
            ILVR_B4_SH(zero, p1_org, zero, p0_org, zero, q0_org, zero, q1_org, p1_org_r, p0_org_r, q0_org_r, q1_org_r);
            AVC_LPF_P0_OR_Q0(p0_org_r, q1_org_r, p1_org_r, p0_r);
            AVC_LPF_P0_OR_Q0(q0_org_r, p1_org_r, q1_org_r, q0_r);
        }
        ...
        if (!__msa_test_bz_v(is_less_than_l)) {
            ...
            ILVL_B4_SH(zero, p1_org, zero, p0_org, zero, q0_org, zero, q1_org, p1_org_l, p0_org_l, q0_org_l, q1_org_l);
            AVC_LPF_P0_OR_Q0(p0_org_l, q1_org_l, p1_org_l, p0_l);
            AVC_LPF_P0_OR_Q0(q0_org_l, p1_org_l, q1_org_l, q0_l);
        }
...
static void avc_lpf_cbcr_interleaved_intra_edge_ver_msa(uint8_t *p_chroma, uint8_t u_alpha_in, uint8_t u_beta_in, uint32_t u_img_width)
{
    v16u8 is_less_than;
    v16u8 p0, q0, p1_org, p0_org, q0_org, q1_org;
    v8i16 p0_r = {0};
    ...
    LD_UB8((p_chroma - 4), u_img_width, row0, row1, row2, row3, row4, row5, row6, row7);

    TRANSPOSE8x8_UB_UB(row0, row1, row2, row3, row4, row5, row6, row7, p1_u_org, p1_v_org, p0_u_org, p0_v_org, q0_u_org, q0_v_org, q1_u_org,
                       q1_v_org);

    ILVR_D4_UB(p1_v_org, p1_u_org, p0_v_org, p0_u_org, q0_v_org, q0_u_org, q1_v_org, q1_u_org, p1_org, p0_org, q0_org, q1_org);
...
static void avc_loopfilter_luma_inter_edge_ver_msa(uint8_t *p_data, uint8_t u_bs0, uint8_t u_bs1, uint8_t u_bs2, uint8_t u_bs3, uint8_t u_tc0,
                                                   uint8_t u_tc1, uint8_t u_tc2, uint8_t u_tc3, uint8_t u_alpha_in, uint8_t u_beta_in,
                                                   uint32_t u_img_width)
{
    ...
    if (!__msa_test_bz_v(bs)) {
...

        {
            ...
            LD_UB8(p_src, u_img_width, row0, row1, row2, row3, row4, row5, row6, row7);
            p_src += (8 * u_img_width);
            LD_UB8(p_src, u_img_width, row8, row9, row10, row11, row12, row13, row14, row15);
        ...
        if (!__msa_test_bz_v(is_less_than)) {
...

            {
                ...
                if (!__msa_test_bz_v(is_less_than_beta_r)) {
                    ...
                    AVC_LPF_P1_OR_Q1(p0_org_r, q0_org_r, p1_org_r, p2_org_r, negate_tc_r, tc_r, p1_r);
                }
                ...
                if (!__msa_test_bz_v(is_less_than_beta_l)) {
                    ...
                    AVC_LPF_P1_OR_Q1(p0_org_l, q0_org_l, p1_org_l, p2_org_l, i16_negatetc_l, tc_l, p1_l);
                }
            }
...

            {
                ...
                if (!__msa_test_bz_v(is_less_than_beta_r)) {
                    ...
                    AVC_LPF_P1_OR_Q1(p0_org_r, q0_org_r, q1_org_r, q2_org_r, negate_tc_r, tc_r, q1_r);
                }
                ...
                if (!__msa_test_bz_v(is_less_than_beta_l)) {
                    ...
                    AVC_LPF_P1_OR_Q1(p0_org_l, q0_org_l, q1_org_l, q2_org_l, i16_negatetc_l, tc_l, q1_l);
                }
            }
...

            {
                ...
                ILVR_B2_SH(zero, tc, sign_negate_thresh, negate_thresh, threshold_r, negate_thresh_r);

                AVC_LPF_P0Q0(q0_org_r, p0_org_r, p1_org_r, q1_org_r, negate_thresh_r, threshold_r, p0_r, q0_r);

                threshold_l = (v8i16)__msa_ilvl_b(zero, (v16i8)tc);
                negate_thresh_l = (v8i16)__msa_ilvl_b(sign_negate_thresh, negate_thresh);

                AVC_LPF_P0Q0(q0_org_l, p0_org_l, p1_org_l, q1_org_l, negate_thresh_l, threshold_l, p0_l, q0_l);
            }
...
static void avc_loopfilter_luma_inter_edge_hor_msa(uint8_t *p_data, uint8_t u_bs0, uint8_t u_bs1, uint8_t u_bs2, uint8_t u_bs3, uint8_t u_tc0,
                                                   uint8_t u_tc1, uint8_t u_tc2, uint8_t u_tc3, uint8_t u_alpha_in, uint8_t u_beta_in,
                                                   uint32_t u_image_width)
{
    ...
    if (!__msa_test_bz_v(bs)) {
        ...
        LD_UB5(p_data - (3 * u_image_width), u_image_width, p2_org, p1_org, p0_org, q0_org, q1_org);
...
static void avc_lpf_cbcr_interleaved_inter_edge_hor_msa(uint8_t *p_chroma, uint8_t u_bs0, uint8_t u_bs1, uint8_t u_bs2, uint8_t u_bs3, uint8_t u_tc0,
                                                        uint8_t u_tc1, uint8_t u_tc2, uint8_t u_tc3, uint8_t u_alpha_in, uint8_t u_beta_in,
                                                        uint32_t u_img_width)
{
    v16u8 alpha, beta;
    ...
    if (!__msa_test_bz_v((v16u8)bs)) {
        ...
        if (!__msa_test_bz_v(is_less_than)) {
            ...
            is_less_than_r = (v8i16)__msa_sldi_b((v16i8)is_less_than, zero, 8);
            if (!__msa_test_bz_v((v16u8)is_less_than_r)) {
                AVC_LPF_P0Q0(q0_org_r, p0_org_r, p1_org_r, q1_org_r, negate_tc_r, tc_r, p0_r, q0_r);
            }

            is_less_than_l = (v8i16)__msa_sldi_b(zero, (v16i8)is_less_than, 8);
            if (!__msa_test_bz_v((v16u8)is_less_than_l)) {
                AVC_LPF_P0Q0(q0_org_l, p0_org_l, p1_org_l, q1_org_l, i16_negatetc_l, tc_l, p0_l, q0_l);
            }
...
static void avc_lpf_cbcr_interleaved_inter_edge_ver_msa(uint8_t *p_chroma, uint8_t u_bs0, uint8_t u_bs1, uint8_t u_bs2, uint8_t u_bs3, uint8_t u_tc0,
                                                        uint8_t u_tc1, uint8_t u_tc2, uint8_t u_tc3, uint8_t u_alpha_in, uint8_t u_beta_in,
                                                        uint32_t u_img_width)
{
    v16u8 alpha, beta;
    ...
    if (!__msa_test_bz_v((v16u8)bs)) {
        ...
        if (!__msa_test_bz_v(is_less_than)) {
            ...
            if (!__msa_test_bz_v((v16u8)is_less_than1)) {
                ...
                is_less_than_r = (v8i16)__msa_sldi_b((v16i8)is_less_than1, zero, 8);
                if (!__msa_test_bz_v((v16u8)is_less_than_r)) {
                    AVC_LPF_P0Q0(q0_org_r, p0_org_r, p1_org_r, q1_org_r, negate_tc_r, tc_r, p0_r, q0_r);
                }

                is_less_than_l = (v8i16)__msa_sldi_b(zero, (v16i8)is_less_than1, 8);
                if (!__msa_test_bz_v((v16u8)is_less_than_l)) {
                    AVC_LPF_P0Q0(q0_org_l, p0_org_l, p1_org_l, q1_org_l, i16_negatetc_l, tc_l, p0_l, q0_l);
                }
...
static void avc_deblock_strength_msa(uint8_t *nnz, int8_t pi_ref[2][X264_SCAN8_LUMA_SIZE], int16_t pi_mv[2][X264_SCAN8_LUMA_SIZE][2],
...
void x264_deblock_v_luma_intra_msa(uint8_t *p_pix, intptr_t i_stride, int32_t i_alpha, int32_t i_beta)
{
    avc_loopfilter_luma_intra_edge_hor_msa(p_pix, (uint8_t)i_alpha, (uint8_t)i_beta, i_stride);
}

void x264_deblock_h_luma_intra_msa(uint8_t *p_pix, intptr_t i_stride, int32_t i_alpha, int32_t i_beta)
{
    avc_loopfilter_luma_intra_edge_ver_msa(p_pix, (uint8_t)i_alpha, (uint8_t)i_beta, i_stride);
}

void x264_deblock_v_chroma_intra_msa(uint8_t *p_pix, intptr_t i_stride, int32_t i_alpha, int32_t i_beta)
{
    avc_lpf_cbcr_interleaved_intra_edge_hor_msa(p_pix, (uint8_t)i_alpha, (uint8_t)i_beta, i_stride);
}

void x264_deblock_h_chroma_intra_msa(uint8_t *p_pix, intptr_t i_stride, int32_t i_alpha, int32_t i_beta)
{
    avc_lpf_cbcr_interleaved_intra_edge_ver_msa(p_pix, (uint8_t)i_alpha, (uint8_t)i_beta, i_stride);
}

void x264_deblock_h_luma_msa(uint8_t *p_pix, intptr_t i_stride, int32_t i_alpha, int32_t i_beta, int8_t *p_tc0)
{
    uint8_t u_bs0 = 1;
    uint8_t u_bs1 = 1;
    uint8_t u_bs2 = 1;
    ...
    avc_loopfilter_luma_inter_edge_ver_msa(p_pix, u_bs0, u_bs1, u_bs2, u_bs3, p_tc0[0], p_tc0[1], p_tc0[2], p_tc0[3], i_alpha, i_beta, i_stride);
}

void x264_deblock_v_luma_msa(uint8_t *p_pix, intptr_t i_stride, int32_t i_alpha, int32_t i_beta, int8_t *p_tc0)
{
    uint8_t u_bs0 = 1;
    uint8_t u_bs1 = 1;
    uint8_t u_bs2 = 1;
    ...
    avc_loopfilter_luma_inter_edge_hor_msa(p_pix, u_bs0, u_bs1, u_bs2, u_bs3, p_tc0[0], p_tc0[1], p_tc0[2], p_tc0[3], i_alpha, i_beta, i_stride);
}

void x264_deblock_v_chroma_msa(uint8_t *p_pix, intptr_t i_stride, int32_t i_alpha, int32_t i_beta, int8_t *p_tc0)
{
    uint8_t u_bs0 = 1;
    uint8_t u_bs1 = 1;
    uint8_t u_bs2 = 1;
    ...
    avc_lpf_cbcr_interleaved_inter_edge_hor_msa(p_pix, u_bs0, u_bs1, u_bs2, u_bs3, p_tc0[0], p_tc0[1], p_tc0[2], p_tc0[3], i_alpha, i_beta, i_stride);
}

void x264_deblock_h_chroma_msa(uint8_t *p_pix, intptr_t i_stride, int32_t i_alpha, int32_t i_beta, int8_t *p_tc0)
{
    uint8_t u_bs0 = 1;
    uint8_t u_bs1 = 1;
    uint8_t u_bs2 = 1;
    ...
    avc_lpf_cbcr_interleaved_inter_edge_ver_msa(p_pix, u_bs0, u_bs1, u_bs2, u_bs3, p_tc0[0], p_tc0[1], p_tc0[2], p_tc0[3], i_alpha, i_beta, i_stride);
}

void x264_deblock_strength_msa(uint8_t u_nnz[X264_SCAN8_SIZE], int8_t pi_ref[2][X264_SCAN8_LUMA_SIZE], int16_t pi_mv[2][X264_SCAN8_LUMA_SIZE][2],
                               uint8_t pu_bs[2][8][4], int32_t i_mvy_limit, int32_t i_bframe)
{
    if (i_bframe) {
        for (int32_t i_dir = 0; i_dir < 2; i_dir++) {
            ...
            for (int32_t i_edge = 0; i_edge < 4; i_edge++) {
                for (int32_t i = 0, loc = X264_SCAN8_0 + i_edge * s2; i < 4; i++, loc += s1) {
                    int32_t locn = loc - s2;
                    if (u_nnz[loc] || u_nnz[locn]) {
                        pu_bs[i_dir][i_edge][i] = 2;
                    } else if (pi_ref[0][loc] != pi_ref[0][locn] || abs(pi_mv[0][loc][0] - pi_mv[0][locn][0]) >= 4 ||
                               abs(pi_mv[0][loc][1] - pi_mv[0][locn][1]) >= i_mvy_limit ||
                               (i_bframe && (pi_ref[1][loc] != pi_ref[1][locn] || abs(pi_mv[1][loc][0] - pi_mv[1][locn][0]) >= 4 ||
                                             abs(pi_mv[1][loc][1] - pi_mv[1][locn][1]) >= i_mvy_limit))) {
