...
void x264_dequant_4x4_msa(int16_t *p_dct, int32_t pi_dequant_mf[6][16], int32_t i_qp);
#define x264_dequant_8x8_msa x264_template(dequant_8x8_msa)
void x264_dequant_8x8_msa(int16_t *p_dct, int32_t pi_dequant_mf[6][64], int32_t i_qp);
#define x264_dequant_4x4_dc_msa x264_template(dequant_4x4_dc_msa)
void x264_dequant_4x4_dc_msa(int16_t *p_dct, int32_t pi_dequant_mf[6][16], int32_t i_qp);
